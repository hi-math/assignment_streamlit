...
# # OpenAI API 키 설정
# client = OpenAI(
#   api_key=os.environ["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"],
# )
...
# # GPT API에 전달할 질문 생성
# question = f"나의 우선순위는 {', '.join([f'{rank}순위: {item}' for rank, (item, _) in enumerate(rankings_sorted, start=1)])} 어떤 직업 분야가 어울릴까요?"
